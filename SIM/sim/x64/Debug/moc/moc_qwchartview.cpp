...
void QWChartView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<QWChartView *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (QWChartView::*)(QPoint );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QWChartView::mouseMovePoint)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject QWChartView::staticMetaObject = { {
    &QChartView::staticMetaObject,
    qt_meta_stringdata_QWChartView.data,
    qt_meta_data_QWChartView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
